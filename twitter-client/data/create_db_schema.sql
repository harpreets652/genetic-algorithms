...
CREATE TABLE TSS_DEV.USERS_FEATURES (
  ...
  fract_contains_emoticon             DECIMAL  DEFAULT NULL,
  ...
  fract_urls_top_100                  DECIMAL  DEFAULT NULL,
  fract_contains_user_mention         DECIMAL  DEFAULT NULL,
  fract_contains_hashtag              DECIMAL  DEFAULT NULL,
  fract_contains_company              DECIMAL  DEFAULT NULL,
  fract_self_promoting                DECIMAL  DEFAULT NULL,
  fract_retweeted                     DECIMAL  DEFAULT NULL,
  num_tweets_day_sun                  INTEGER  DEFAULT NULL,
  num_tweets_day_mon                  INTEGER  DEFAULT NULL,
  num_tweets_day_tues                 INTEGER  DEFAULT NULL,
  num_tweets_day_wed                  INTEGER  DEFAULT NULL,
  num_tweets_day_thur                 INTEGER  DEFAULT NULL,
  num_tweets_day_fri                  INTEGER  DEFAULT NULL,
  num_tweets_day_sat                  INTEGER  DEFAULT NULL,
  ...
  fract_source_unpopular              DECIMAL  DEFAULT NULL,
  fract_source_unpop_w_url            DECIMAL  DEFAULT NULL,
  ...
  user_reputation_ratio               DECIMAL  DEFAULT NULL,
  user_followers_to_lifetime          DECIMAL  DEFAULT NULL,
